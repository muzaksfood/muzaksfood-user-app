...
class ConfigModel {
  ...
  ConfigModel(
    ...
    if(expressDelivery != null){
      _expressDelivery = expressDelivery;
    }
  ...
  ExpressDelivery? get expressDelivery => _expressDelivery;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _expressDelivery = json['express_delivery'] != null
...
class ExpressDelivery {
  ...
  ExpressDelivery.fromJson(Map<String, dynamic> json)
      : status = json['status'] == 1 || json['status'] == '1',
        ...
        slaMinutes = int.tryParse('${json['sla_minutes']}'),
        radiusKm = double.tryParse('${json['radius_km']}');
